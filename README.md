This map uses Turf.js and Mapbox to create dynamic hub and spoke maps. It uses code written by William B. Davis and then adapted by Garrett Dash Nelson and Alasdair Rae.
